...
class PhotoInfoBase : public ::google::protobuf::Message {
 public:
  ...
  // optional string last_publisher = 3;
  inline bool has_last_publisher() const;
  inline void clear_last_publisher();
  static const int kLastPublisherFieldNumber = 3;
  inline const ::std::string& last_publisher() const;
  inline void set_last_publisher(const ::std::string& value);
  inline void set_last_publisher(const char* value);
  inline void set_last_publisher(const char* value, size_t size);
  inline ::std::string* mutable_last_publisher();
  inline ::std::string* release_last_publisher();
  inline void set_allocated_last_publisher(::std::string* last_publisher);
  ...
  // @@protoc_insertion_point(class_scope:sxg.PhotoInfoBase)
 private:
...
inline void PhotoInfoBase::clear_last_publisher() {
  if (last_publisher_ != &::google::protobuf::internal::kEmptyString) {
    last_publisher_->clear();
  }
  clear_has_last_publisher();
}
inline const ::std::string& PhotoInfoBase::last_publisher() const {
  return *last_publisher_;
}
inline void PhotoInfoBase::set_last_publisher(const ::std::string& value) {
  set_has_last_publisher();
  if (last_publisher_ == &::google::protobuf::internal::kEmptyString) {
    last_publisher_ = new ::std::string;
  }
  last_publisher_->assign(value);
}
inline void PhotoInfoBase::set_last_publisher(const char* value) {
  set_has_last_publisher();
  if (last_publisher_ == &::google::protobuf::internal::kEmptyString) {
    last_publisher_ = new ::std::string;
  }
...
inline void PhotoInfoBase::set_last_publisher(const char* value, size_t size) {
  set_has_last_publisher();
  if (last_publisher_ == &::google::protobuf::internal::kEmptyString) {
    last_publisher_ = new ::std::string;
  }
  last_publisher_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* PhotoInfoBase::mutable_last_publisher() {
  set_has_last_publisher();
  if (last_publisher_ == &::google::protobuf::internal::kEmptyString) {
    last_publisher_ = new ::std::string;
  }
...
inline ::std::string* PhotoInfoBase::release_last_publisher() {
  clear_has_last_publisher();
  if (last_publisher_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
    ::std::string* temp = last_publisher_;
    last_publisher_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
inline void PhotoInfoBase::set_allocated_last_publisher(::std::string* last_publisher) {
  if (last_publisher_ != &::google::protobuf::internal::kEmptyString) {
    delete last_publisher_;
  }
  if (last_publisher) {
    set_has_last_publisher();
    last_publisher_ = last_publisher;
  } else {
    clear_has_last_publisher();
    last_publisher_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
