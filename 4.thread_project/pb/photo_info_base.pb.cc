...
void protobuf_AddDesc_photo_5finfo_5fbase_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\025photo_info_base.proto\022\003sxg\"\201\001\n\rPhotoIn"
    "foBase\022\013\n\003ver\030\001 \001(\005\022\017\n\007user_id\030\002 \001(\005\022\026\n\016"
    "last_publisher\030\003 \001(\t\022\031\n\021last_publish_tim"
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_last_publisher;
        break;
      }
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_last_publisher:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_last_publisher()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->last_publisher().data(), this->last_publisher().length(),
