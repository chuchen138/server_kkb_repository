...
int SendGetPhotoReq2(){
    SetReqMessType("203");
    getPhotoReq2.SerializeToArray(send_buffer+3,4090);
    int size_buffer=sizeof(send_buffer);
    int ret=send(sock, send_buffer, size_buffer, 0);
    if(ret>0){
        return 0;
...
int SendRegReq1(){
    SetReqMessType("401");
    regReq1.SerializeToArray(send_buffer+3,4090);
    int size_buffer=sizeof(send_buffer);
    int ret=send(sock, send_buffer, size_buffer, 0);
    if(ret>0){
        return 0;
...
int SendRegReq2(){
    SetReqMessType("401");
    regReq2.SerializeToArray(send_buffer+3,4090);
    int size_buffer=sizeof(send_buffer);
    int ret=send(sock, send_buffer, size_buffer, 0);
    if(ret>0){
        return 0;
...
int SendLoginReq1(){
    SetReqMessType("101");
    loginReq1.SerializeToArray(send_buffer+3,4090);
    int size_buffer=sizeof(send_buffer);
    int ret=send(sock, send_buffer, size_buffer, 0);
    if(ret>0){
        return 0;
...
int SendLoginReq2(){
    SetReqMessType("101");
    loginReq2.SerializeToArray(send_buffer+3,4090);
    int size_buffer=sizeof(send_buffer);
    int ret=send(sock, send_buffer, size_buffer, 0);
    if(ret>0){
        return 0;
...
int SendAddFriendReq1(){
    SetReqMessType("301");
    addFriendReq1.SerializeToArray(send_buffer+3,4090);
    int size_buffer=sizeof(send_buffer);
    int ret=send(sock, send_buffer, size_buffer, 0);
    if(ret>0){
        return 0;
...
int SendPublishMessageReq1(){
    SetReqMessType("201");
    publishReq1.SerializeToArray(send_buffer+3,4090);
    int size_buffer=sizeof(send_buffer);
    int ret=send(sock, send_buffer, size_buffer, 0);
    if(ret>0){
        return 0;
...
int RecvRsp(){
    ...
    if(ret>0){
        ...
        switch(mess_type){
            ...
            publishRsp1.ParseFromArray(recv_buffer+3,4090);
            printf("Received PublishMessageRsp:\n");
            printf("ret      : %d\n", publishRsp1.ret());
            break;
            case ADD_FRIEND_RSP:
            addFriendRsp1.ParseFromArray(recv_buffer+3,4090);
            printf("Received AddFriendRsp:\n");
            printf("ret      : %d\n", addFriendRsp1.ret());
            break;
            case LOGIN_RSP:
            loginRsp1.ParseFromArray(recv_buffer+3,4090);
            printf("Received LoginRsp:\n");
            printf("ret	 : %d\n", loginRsp1.ret());
            printf("user_id : %d\n", loginRsp1.user_id());
            break;
            case REG_RSP:
            regRsp1.ParseFromArray(recv_buffer+3,4090);
            ...
            break;
            case GET_PHOTO_RSP:
                getPhotoRsp2.ParseFromArray(recv_buffer+3,4090);
